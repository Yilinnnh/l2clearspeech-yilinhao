...
{\caption{{Table I.}{\label{tbl-earlydata}}}
\vspace{-20pt}}
...
(\texttt{beta\ =} 9.64, \texttt{t\ =} 3.44, p = 0.0024).

\begin{figure}[!htbp]

{\caption{{Fig. I}{\label{fig-f0-boxplot}}}}

\pandocbounded{\includegraphics[keepaspectratio]{Final_project_files/figure-pdf/fig-f0-boxplot-1.pdf}}
...
{\caption{{Fig. II}{\label{fig-f0range-boxplot}}}}

\pandocbounded{\includegraphics[keepaspectratio]{Final_project_files/figure-pdf/fig-f0range-boxplot-1.pdf}}
