...
gain (Bradlow and Bent, 2002). Although non-native speakers face different challenges in
...
features such as a slower speaking rate and a wider dynamic pitch range (Bradlow and Bent,
2002). Recent studies have shown that clear speech has an overall effect in increasing
intelligibility gain regardless of language background, and the benefit difference between l2
speakers and native speakers is not significant (Jung, Dmitrieva, 2023). In addition, L2 speakers
...
speaker_group1 <- read.csv("~/Desktop/ma_thesis/N-NN.csv")
speaker_group2 <- read.csv("~/Desktop/ma_thesis/NN1-NN1.csv")
speaker_group3 <- read.csv("~/Desktop/ma_thesis/NN1-NN2.csv")
